<template>
    <div style="width: 200px" >
      <!-- <div :width="frame"> -->
        <!-- <div v-if="frame == '300'" style="width: 300px" > -->
            <!-- <div :style="frame"> -->
            
    <v-chip-group  >
    <v-chip 
        v-for="key,value in spots"
      label
      :color="key[0]"
    ...
    >
      {{ value }}
      <v-icon v-if="key[1] == 'C'">mdi-umbrella</v-icon>
    </v-chip>
    ...
    export default {
      data() {
        return {
            bays: {
                "330": ["reserved", "uncovered"],
                "331": ["reserved", "uncovered"],
                "332": ["reserved", "uncovered"],
                "333": ["reserved", "uncovered"],
            }
